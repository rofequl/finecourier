                        ...
                        <div class="blog_slider">
                            ...
                            @foreach($news as $newss)
                                <div class="single_blog_wrapper">
                                    <div class="blog_img">
                                        <img src="{{asset('storage/news/'.$newss->image)}}" alt="service-img"
                                    ...
                                    <div class="blog_content">
                                        ...
                                        <div class="blog_meta">
                                            <ul>
                                                <li><a href="#"><span class="fa fa-user"></span>{{$newss->name}}</a>
                                                </li>
                                                <li><a href="#"><span class="fa fa-commenting-o"></span>250</a></li>
                                                <li><a href="#"><span class="fa fa-heart-o"></span>{{$newss->like}}</a>
                                                </li>
                                            </ul>
                                        </div>
