                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            <div class="btn-group btn-group-justified">
                                <div class="btn-group">
                                    <button type="button"
                                            onclick="location.href='{{route('DriverShipment','type='.base64_encode(1))}}';"
                                            id="international" class="btn {{$change==1?'btn-primary':'btn-default'}} ">International
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button type="button"
                                            onclick="location.href='{{route('DriverShipment','type='.base64_encode(2))}}';"
                                            id="domestic" class="btn {{$change==2?'btn-primary':'btn-default'}}">Domestic</button>
                                </div>
                            </div>
                                ...
                                <table class="table table-striped table-bordered projects">
                                    ...
                                    @foreach($shipping as $shipment)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="{{route('DriverShipmentView','data='.base64_encode($shipment->id))}}" class="btn btn-success"><i class="mdi mdi-teamviewer" style="margin-right: 4px;"></i>View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
