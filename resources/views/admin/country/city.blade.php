                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" method="post"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    ...
                                    <select class="col-md-7 col-xs-12 select2_single" name="state_code"
                                            id="state_code">
                                        <option></option>
                                    </select>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" placeholder="Mecca" name="name"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    ...
                                    <input type="text" class="form-control" placeholder="21.42664" name="latitude"
                                           id="latitude" value="{{old('latitude')}}">
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    <label for="longitude">Longitude:</label>
                                    <input type="text" class="form-control" placeholder="39.82563" name="longitude"
                                           id="longitude" value="{{old('longitude')}}">
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    <label for="population">population:</label>
                                    <input type="text" class="form-control" placeholder="1323624" name="population"
