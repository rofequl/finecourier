...
@section('pageTitle','Shipping price calculate')
@section('content')
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Shipping price calculate</h3>
                </div>
            </div>
                            ...
                            <form action="" method="post" id="upload_form2">
                                ...
                                <div class="quote_btn_wrapper">
                                    <button class="btn btn-primary" type="submit"
                                        ...
                                        <i class="mdi mdi-calculator"></i> Check Rate
                                    </button>
                                </div>
                            </form>
                        </div>
                            ...
                            <form action="#" method="post" id="upload_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group text-left">
                                        ...
                                        <select class="select2_single form-control" name="FromState"
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group text-left">
                                        ...
                                        <select class="select2_single form-control" name="FromCity"
                                    ...
                                    <div class="col-md-6 form-group text-left">
                                        ...
                                        <select class="select2_single form-control" name="ToState"
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group text-left">
                                        <div class="col-md-12" style="padding-left: 0;">
                                            ...
                                            <select class="select2_single form-control" name="ToCity"
                                ...
                                <div class="quote_btn_wrapper">
                                    <button class="btn btn-primary" type="submit"
                                            style="margin-left: auto;margin-right: auto;display: block"><i class="mdi mdi-calculator"></i>Check Rate
                                    </button>
                                </div>
                            </form>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.error == 'error') {
                            ...
                            if (!$('#NotFoundz').hasClass('hidden')) {
                                $('#NotFoundz').addClass('hidden');
                            }
