                    ...
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    <form class="form-horizontal form-label-left" novalidate=""
                                          action="{{ route('OurServiceAdd') }}" method="post"
                                          enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <span class="section">Add Our Service</span>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Service
                                                Image</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div onclick="chooseFile()" id="previewImage">
                                                    <div class="mt-5">
                                        ...
                                        <table class="table table-bordered bulk_action">
                                            ...
                                            @foreach($data as $datas)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="{{asset('storage/service/'.$datas->image)}}"
                                                             width="100px"></td>
                                                    <td>
                                                        @if($datas->status == 0)
                                                            <a href="{{route('OurServiceStatus','show='.$datas->id)}}"
                                                               type="button" class="btn btn-sm btn-success"
                                                               data-toggle="tooltip" data-placement="top" title=""
                                                               data-original-title="Click Show your Service">Inactive
                                                            </a>
                                                        @else
                                                            <a href="{{route('OurServiceStatus','hide='.$datas->id)}}"
                                                               type="button" class="btn btn-sm btn-primary"
                                                               data-toggle="tooltip" data-placement="top" title=""
                                                               data-original-title="Click Hide your Service">Active
                                                            </a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <a href="{{route('OurService',$datas->id)}}" style="margin: 0 2px" data-toggle="tooltip"
                                                           data-placement="top" title=""
                                                           data-original-title="Edit"><i
                                                                    class="fa fa-edit fa-2x"></i></a>
                                                        <a href="{{route('OurServiceDelete','delete='.$datas->id)}}" style="margin: 0 2px" data-toggle="tooltip"
                                                           data-placement="top" title=""
