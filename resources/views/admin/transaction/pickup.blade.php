                        ...
                        <div class="x_content hidden product-info">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="checkbox">
                                        <input type="checkbox" class="payment-input" data-width="100px" data-onstyle="success" data-offstyle="danger" data-on="Paid" data-off="Not Paid" data-toggle="toggle">
                                        <span style="line-height: 34px;">Payment?</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <p>Shipping type: <span class="shipment"></span></p>
                                    <p>Status: <span class="status label label-success"></span></p>
...
@push('style')
    ...
    <link href="{{asset('assets/vendors/bootstrap-toggle/style.css')}}" rel="stylesheet">
@endpush
                    ...
                    success: function (data) {
                        if (data.done === 'shipment') {
                            ...
                            if (data.data.status == 1){
                                $('.status').html('Label Create');
                            }else if(data.data.status == 2){
                                $('.status').html('Pickup');
                            }else if(data.data.status == 3){
                                $('.status').html('Dispatch Center');
                            }else if(data.data.status == 4){
                                $('.status').html('In Transit');
                            }else if(data.data.status == 5){
                                $('.status').html('BloOut for Deliveryck');
