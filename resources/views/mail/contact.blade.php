    ...
    <tr style="vertical-align: top;" valign="top">
        <td style="word-break: break-word; vertical-align: top; border-collapse: collapse;" valign="top">
            ...
            <div style="background-color:transparent;">
                <div class="block-grid" data-body-width-father="650px" rel="col-num-container-box-father"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
                        ...
                        <![endif]-->
                        <div class="col num12" data-body-width-son="650" rel="col-num-container-box-son"
                                        ...
                                        <tr style="vertical-align: top;" valign="top">
                                            <td class="divider_inner"
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                       ...
                                                       style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; border-top: 0px solid transparent; height: 15px;"
                                                       valign="top" width="100%">
                                                    <tbody>
                                                    <tr style="vertical-align: top;" valign="top">
                                                        <td height="15"
            ...
            <div style="background-color:transparent;">
                <div class="block-grid" data-body-width-father="650px" rel="col-num-container-box-father"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                        ...
                        <![endif]-->
                        <div class="col num12" data-body-width-son="634" rel="col-num-container-box-son"
                             style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top;">
                            <div style="background-color:#FFFFFF;width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:50px; padding-bottom:5px; padding-right: 50px; padding-left: 50px;">
                                    ...
                                    <div style="color:#CFCFCF;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 14px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #ccc4c4;">
                                            <p style="font-size: 15px; line-height: 16px; text-align: left; margin: 0;">
                                                <strong>A Message From Contact Page,</strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mobile_hide">
                                        ...
                                        <div style="color:#66BECD;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                            <div style="line-height: 14px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color: #66BECD;">
                                                <p style="line-height: 32px; font-size: 12px; margin: 0;"><span
                                                            style="font-size: 28px;">Name: {{$data->name}}</span></p>
                                                <p style="font-size: 14px; line-height: 33px; margin: 0;"><span
                                                            style="font-size: 28px;"><span
                                                                style="line-height: 33px; font-size: 28px;">Phone: {{$data->phone}}</span></span>
                                                </p>
                                                <p style="font-size: 14px; line-height: 33px; margin: 0;"><span
                                                            style="font-size: 28px;"><span
                                                                style="line-height: 33px; font-size: 28px;">Email: {{$data->email}}</span></span>
                                                </p>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:25px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="center" class="img-container center autowidth fullwidth"
                                        ...
                                        <img align="center" alt="Image" border="0" class="center autowidth fullwidth"
                                             src="http://kajerkhojay.com/finecourier/images/mail/divider.png"
                                             style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; border: 0; height: auto; float: none; width: 100%; max-width: 634px; display: block;"
                                    ...
                                    <div style="color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;padding-top:15px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 18px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #555555;">
                                            <p style="font-size: 14px; line-height: 25px; text-align: left; margin: 0;">
                                                <span style="font-size: 17px; mso-ansi-font-size: 18px;">{{$data->message}}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                ...
                                <div style="border-top:0px solid transparent; border-left:8px solid #F1F3F3; border-bottom:0px solid transparent; border-right:8px solid #F1F3F3; padding-top:30px; padding-bottom:25px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div align="center" class="img-container center fixedwidth"
                                        ...
                                        <![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth"
                                                         src="http://kajerkhojay.com/finecourier/images/footer_logo.png"
                                                         style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; border: 0; height: auto; float: none; width: 100%; max-width: 158px; display: block;"
                                    ...
                                    <table cellpadding="0" cellspacing="0" class="social_icons" role="presentation"
                                        ...
                                        <tbody>
                                        <tr style="vertical-align: top;" valign="top">
                                            <td style="word-break: break-word; vertical-align: top; padding-top: 5px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; border-collapse: collapse;"
                                                valign="top">
                                                <table activate="activate" align="center" alignment="alignment"
                                                    ...
                                                    <tr align="center"
                                                        ...
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px; border-collapse: collapse;"
                                                            valign="top"><a href="{{basic_information()->facebook_link}}"
                                                                            target="_blank"><img alt="Facebook"
                                                                                                 height="32"
                                                                                                 src="http://kajerkhojay.com/finecourier/images/mail/facebook@2x.png"
                                                                                                 ...
                                                                                                 width="32"/></a></td>
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px; border-collapse: collapse;"
                                                            valign="top"><a href="{{basic_information()->twiter_link}}" target="_blank"><img
                                                                        alt="Twitter" height="32"
                                                                        src="http://kajerkhojay.com/finecourier/images/mail/twitter@2x.png"
                                                                        style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; display: block;"
                                                        ...
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px; border-collapse: collapse;"
                                                            valign="top"><a href="https://instagram.com/"
                                                                            target="_blank"><img alt="Instagram"
                                                                                                 height="32"
                                                                                                 src="http://kajerkhojay.com/finecourier/images/mail/instagram@2x.png"
                                                                                                 style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; display: block;"
                                                                                                 title="Instagram"
                                                                                                 width="32"/></a></td>
                                                        <td style="word-break: break-word; vertical-align: top; padding-bottom: 5px; padding-right: 5px; padding-left: 5px; border-collapse: collapse;"
                                                            valign="top"><a href="{{basic_information()->linkedin}}"
                                                                            target="_blank"><img alt="LinkedIn"
                                                                                                 height="32"
                                                                                                 src="http://kajerkhojay.com/finecourier/images/mail/linkedin@2x.png"
                                                                                                 style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; height: auto; float: none; border: none; display: block;"
                                                                                                 title="LinkedIn"
                                                                                                 width="32"/></a></td>
                                                    </tr>
                                    ...
                                    <div style="color:#353535;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:0px;padding-left:10px;">
                                        <div style="font-size: 12px; line-height: 14px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #353535;">
                                            <p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;">
                                                <strong>{{basic_information()->footer_text}} <a
                                                            href="{{basic_information()->website_link}}">{{basic_information()->company_name}}</a></strong></p>
                                        </div>
                                    </div>
                                    <!--[if (!mso)&(!IE)]><!-->
                                </div>
